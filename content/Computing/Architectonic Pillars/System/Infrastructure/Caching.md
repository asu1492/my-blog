...
**Summary**: Covers when and how to use caching, including cache placement, cache-aside/write-through patterns, eviction policies, and common failure modes.
**Tags**: #system-design #infrastructure #caching #interview
**Created**: Unknown
...
## Related Notes
1. [[Computing/Architectonic Pillars/Programming Paradigm & Framework/Java/Collections|Collections]] — Java-side: `LinkedHashMap` as a manual LRU cache; `ConcurrentHashMap` for in-process caching
2. [[Consistency Model ACID, BASE]] — when caching introduces eventual consistency, understand the BASE trade-off
3. [[Computing/Architectonic Pillars/System/Infrastructure/Concurrency|Concurrency]] — cache stampede mitigations rely on atomic operations and locking
4. Used in: [[Rate Limiter]] · [[FeedService]]
